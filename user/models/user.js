...
const UserSchema = new mongoose.Schema({
    cin: { type: String, required: true, unique: true, trim: true },        // Stored as image URL
    permis: { type: String, required: true, trim: true },                   // Stored as image URL
    num_phone: { type: String, required: true, trim: true },
    fullName: { type: String, required: true, trim: true },                 // Added fullName field
